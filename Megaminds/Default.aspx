...
<body>
    ...
    <div style="border-style: solid; min-height: 450px">
        <div style="margin-left: 20px;">
            <br />
            &quot;Global Traveller&quot; is a travel tour and&nbsp; guide application which provides the details and minute information about any place to a user. The details could vary from weather, time zone (including sunrise and sunset), various tourists attract in the that places and also could provide details about various upcoming events.
            <br />
            The application management access is only provided to the Admin. Users need to register themselves and login in order to use the services of the application.<br />
        <br />
