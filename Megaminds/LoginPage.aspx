...
<body>
    ...
    <div style="border-style: solid; height: 450px">
        <div style="margin-left: 20px;">
            <br />Global Travellers welcomes you to the login page!!!<br />
            <br />
            <br />
            &nbsp;Username: <asp:TextBox ID="user" runat="server" style="margin-left: 20px" Width="250px" Text="Global Traveller"></asp:TextBox>
            <br /><br />
